...
import { ERC1155 } from "./ERC1155D.sol";
...
contract VVV_FUND_ERC1155D is ERC1155, AccessControl, ReentrancyGuard {
    ...
    function mintBySignature(
        ...
        for(uint256 i = 0; i < _quantity; ++i) {
            ...
            _mintSingle(_to, currentNonReservedId);
        }
    }
