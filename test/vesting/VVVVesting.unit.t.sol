...
contract VVVVestingUnitTests is VVVVestingTestBase {
    ...
    function testSetExistingVestingSchedule() public {
        ...
        {
            //update part of schedule (tokensToVestAfterStart is now 20k, duration is now 3 years)
    ...
    function testBatchSetVestingSchedulesVaryingVestedAddress() public {
        ...
        for (uint256 i = 0; i < numberOfVestedUsers; i++) {
            ...
            assertTrue(
                _tokenAmountPerInterval == (_tokensToVestAfterStart / (_duration / _intervalLength))
            );
        }
    }
    ...
    function testRemainderFromDivisionTruncationIsWithdrawable() public {
        ...
        //at this point, the total vested amount should be tokensToVestAfterStart - tokenAmountPerInterval - truncation error
        //(also equal to 9*tokenAmountPerInterval)

        //then advance 1 more interval to get beyond the end of the schedule, at which point total vested amount should be tokensToVestAfterStart
